    ...
    <div className="flex flex-wrap -m-4 text-center">
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-900">John Doe</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          <img className="w-20 h-20 mb-4 object-cover object-center rounded-full mx-auto" src="https://via.placeholder.com/150" alt="team member"/>
          <h2 className="title-font font-medium text-3xl text-gray-900">Jane Smith</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          <img className="w-20 h-20 mb-4 object-cover object-center rounded-full mx-auto" src="https://via.placeholder.com/150" alt="team member"/>
          <h2 className="title-font font-medium text-3xl text-gray-900">Alex Johnson</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          <img className="w-20 h-20 mb-4 object-cover object-center rounded-full mx-auto" src="https://via.placeholder.com/150" alt="team member"/>
          <h2 className="title-font font-medium text-3xl text-gray-900">Emily Brown</h2>
